...
const (
	...
	setupToolsCmd = `
        apt-get update && 
        apt-get install -y git curl postgresql-client dnsutils iputils-ping ncurses-bin ca-certificates gnupg lsb-release netcat-openbsd libatomic1 && 
